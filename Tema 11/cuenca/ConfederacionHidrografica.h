  ...
  public:
	  ...
	  */
	  ...
	  /**
	    ...
	    @param rio El nombre río al que se va a añadir del pantano.
	  ...
	  */
	  ...
	  /**
	   ...
	   Si alguno de los ríos no existen, se levanta la excepción ERioNoExiste
	   Si alguno de los pantanos no existen, se levanta la excepción EPantanoNoExiste
